    ...
    <div className="relative group bg-slate-50 dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800/90 hover:border-indigo-300 dark:hover:border-indigo-500/30 rounded-2xl p-6 backdrop-blur-xl shadow-md transition-all space-y-4">
      ...
      <div className="flex items-center space-x-3">
        ...
        <div>
          ...
          <p className="text-xs text-slate-500 dark:text-slate-400">Mức giá đề xuất và luận điểm kinh doanh</p>
        </div>
      </div>
      ...
      {pricing?.suggested_price ? (
        <div className="space-y-4">
          <div className="bg-white dark:bg-slate-950 border border-indigo-200 dark:border-indigo-500/30 rounded-xl p-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 shadow-xs">
            <div className="flex items-center space-x-2">
              <Tag className="w-4 h-4 text-indigo-600 dark:text-indigo-400" />
              <span className="text-xs text-slate-600 dark:text-slate-400 font-medium">Khoảng giá tối ưu:</span>
            </div>
            <div className="px-3.5 py-1.5 rounded-lg bg-indigo-50 dark:bg-indigo-500/10 border border-indigo-200 dark:border-indigo-500/30 text-indigo-700 dark:text-indigo-300 font-bold text-base sm:text-lg tracking-wide">
              {pricing.suggested_price}
            </div>
          </div>
          ...
          {/* Rationale */}
          {pricing.rationale && (
            <div className="bg-white dark:bg-slate-950/60 border border-slate-200 dark:border-slate-800/80 rounded-xl p-4 space-y-2 shadow-xs">
        ...
        <div className="bg-slate-100/60 dark:bg-slate-950/40 border border-slate-200 dark:border-slate-800/50 rounded-xl p-6 flex flex-col items-center justify-center text-center space-y-2 text-slate-400 dark:text-slate-500">
          <DollarSign className="w-8 h-8 animate-pulse text-indigo-500/40" />
